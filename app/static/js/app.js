...
const NewsList = Vue.component('news-list',{
  template: `
    ...
    <div class="form-inline d-flex justify-content-center">
      ...
      <ul class="news__list row list-unstyled">
        <li v-for="article in articles" class="news__item col-4">
          <div class="card card-body my-2">
            <h5 class="card-title p-2">{{ article.title }}</h5>
            <img class="card-img p-2" :src="article.urlToImage"/>
            <p class="card-subtitle p-2"> {{ article.description }}</p>
          </div>
        </li>
      </ul>
    </div>
